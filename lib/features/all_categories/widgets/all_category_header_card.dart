...
class AllCategoriesHeaderCard extends StatelessWidget {
  const AllCategoriesHeaderCard({super.key});
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  "Browse all available categories and choose the specialty you need.",
